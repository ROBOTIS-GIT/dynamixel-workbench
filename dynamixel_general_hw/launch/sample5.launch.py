            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "robot_description_file": PathJoinSubstitution(
                        [package_share, "urdf", "sample5.urdf"]
                    ),
                    "controllers_file": PathJoinSubstitution(
                        [package_share, "config", "sample5", "default_controllers.yaml"]
                    ),
                    "controllers_to_start": "joint_state_broadcaster joint_group_effort_controller",
                }.items(),
            ),
        ]
    )
