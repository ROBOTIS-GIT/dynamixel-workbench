...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("dynamixel_id", default_value="1"),
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "robot_description_file": PathJoinSubstitution(
                        [package_share, "urdf", "sample6.urdf"]
                    ),
                    "controllers_file": PathJoinSubstitution(
                        [package_share, "config", "sample6", "default_controllers.yaml"]
                    ),
                    "controllers_to_start": "joint_state_broadcaster position_joint_trajectory_controller joint_group_effort_controller",
                }.items(),
            ),
        ]
    )
