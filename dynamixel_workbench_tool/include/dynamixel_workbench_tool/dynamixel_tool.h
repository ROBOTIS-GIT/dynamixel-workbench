...
namespace dynamixel_workbench_tool
{
class DynamixelWorkbenchTool
{
 public:
 ...
 public:
  DynamixelWorkbenchTool(std::string device_name, float baud_rate, float protocol_version);
  ~DynamixelWorkbenchTool();
 ...
 private:
  bool initDynamixelWorkbenchTool(void);
  bool shutdownDynamixelWorkbenchTool(void);
};
}
